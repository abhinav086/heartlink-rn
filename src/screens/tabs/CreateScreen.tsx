...
const CreateScreen = ({ navigation }) => {
  ...
  // FIXED: Better gallery opening with enhanced video support
  const openGallery = () => {
  ...
  // FIXED: Better camera opening with enhanced video support
  const openCamera = () => {
    // Base options for both photo and video
    const baseOptions = {
      mediaType: contentMode === "reel" ? 'video' : 'photo',
              ...
              <View style={styles.actionButtonContent}>
                ...
                <View style={styles.actionButtonTextContainer}>
                  ...
                  <Text style={styles.actionButtonSubtext}>
                    {contentMode === "reel" 
                      ? "Select any video file - all formats supported" 
